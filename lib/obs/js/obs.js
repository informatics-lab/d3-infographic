var obs = {
  load: function(){
    ...
    var updateSourcesHisto = function(sources, width, height){
      var padding = 2;
    ...
    var main = function(sites, sources) {
        ...
        EVENTS.queueEvent(function(){updateSourcesHisto([{"name": "Weather station", "value": 10},
                       {"name": "Ship", "value": 10}], 400, 70)}, 2000)
        EVENTS.queueEvent(function(){updateSourcesHisto([{"name": "Weather station", "value": 20},
                       {"name": "Ship", "value": 30}], 400, 70)}, 2000)
        EVENTS.queueEvent(function(){updateSourcesHisto([{"name": "Weather station", "value": 500},
                       {"name": "Ship", "value": 400}, {"name": "Ship 2", "value": 40}], 400, 70)}, 2000)
