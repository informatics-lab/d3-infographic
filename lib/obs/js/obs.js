var obs = {
  load: function(){
    ...
    var bob = {"lon": 151.2, "lat": -33.8, "r": ptr*2, "mugshot": "https://pbs.twimg.com/profile_images/1044973752/390dfbe9-eccf-41f9-822e-17c8d4c251b4.jpg", "text": "I'm Bob", "stationID": 1229, "alt": "20", "val": "-0.5", "type": "Weather balloon"};
      ...
      queue()
        ...
        .defer(d3.csv, "/lib/obs/data/obs/surface.csv", function(el){return parseCSV(el, "Land/ships/buoys")})
          .awaitAll(function(error, responses){
            ...
            var sites = d3.merge([responses[3], responses[4], responses[5]]);
