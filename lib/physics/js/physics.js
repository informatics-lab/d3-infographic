var physics = {
  ...
  load: function(){
    ...
    function updateHPCScreen(d, i) {
      d3.select("#info").html(d.eqn + "<br/>" + d.info);
      MathJax.Hub.Typeset();
    }
    ...
    function remove(d, i) {
      ...
      mythis
        ...
        .transition()
          .remove()
          .each("end", function(d, i){updateHPCScreen.apply(this, [d, i])})
    ...
    function constructData(err, datain) {
      ...
      drawGlobe();
      drawLines({"x": 20, "y": 20}, {"x": 200, "y": 200});
    }
    ...
    function drawGlobe(){
      projection = d3.geo.orthographic()
                      .scale(150)
                      .translate([150, 150]) // a third down the svg container div
                      .clipAngle(90);
      ...
      d3.timer(function(elapsed) {
        ...
        projection.rotate([currentrotation[0] + 5, currentrotation[1], currentrotation[2]]);
        redrawGlobe()
      })
    }
