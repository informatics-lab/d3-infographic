function loadskill() {
  ...
  wrapper.append("div").html("<h2>Our forecasts have been <a href=http://www.metoffice.gov.uk/about-us/who/accuracy/forecasts target=_blank>repeatedly ranked</a> as no. 1 in the world</h2>")
    ...
    var init = function(skillsets){
      var showdiv = function() {
        ...
        .append("div") 
            .attr("class", "info show")
            .attr("id", "continue")
            .html("<p>Click to see how we compare to other centers</p>")
            .style("left", "50%")          
            .style("top", "50%")
            .style("display", "block")
            .style("z-index", "1000")
