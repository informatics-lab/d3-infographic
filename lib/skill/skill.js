function loadskill() {
  ...
  var centers = [
      ...
      {'center':'ECMWF', 'file':'lib/skill/data/ECMWF_EC-Anl_norm.csv', 'notes':[], 'colour':"red"},
      {'center':'JMA', 'file':"lib/skill/data/JMA_JA-Anl_norm.csv", 'notes':[], 'colour':"green"},
      {'center':'DWD', 'file':"lib/skill/data/DWD_GE-Anl_norm.csv", 'notes':[], 'colour':"orange"},
  ];
