function loadskill() {
  ...
  var jmanotes = [{'date': parseDate('201401010000'), 'html':'<p>JMA note</p>'}]
  var centers = [
      {'center':'Met Office', 'file':'lib/skill/data/Met_Office-Anl_norm.csv', 'notes':monotes, 'colour':"steelblue"},
      {'center':'NCEP', 'file':'lib/skill/data/NCEP_US-Anl_norm.csv', 'notes':[], 'colour':"red"},
      {'center':'JMA', 'file':"lib/skill/data/JMA_JA-Anl_norm.csv", 'notes':jmanotes, 'colour':"green"},
      {'center':'BoM', 'file':"lib/skill/data/BoM_AU_UM_partner-Anl_norm.csv", 'notes':[], 'colour':"orange"},
  ];
          ...
          .duration(lineDuration)
            ...
            .each("end", function(){
              ...
              d3.selectAll(".note")
                ...
                svg.append("text") // label the lines
                .attr("transform", "translate(" + (width-50) + "," + 100 + ")")
                .attr("dy", ".35em")
                .attr("text-anchor", "start")
                .style("fill", function(d,i){return centers[i].colour})
                .text(function(d,i){return centers[i].center})
