  ...
  load: function(){
   ...
   .defer(d3.xhr, "/lib/forecasts/templates/tooltip.mst")
    ...
    var init = function(data){
      ...
      var histo = svgwrapper.append("svg").attr("id", "users-histo");
      ...
      site.enter()
            .append("path")
              ...
              .attr("d", function(d) {d.r=0; return pointpath(d)})
                .transition()
                .call(function(transition){return growPointTrans(transition, ptr, ptr, pointdrawduration)})
                .each("end", function(d){
                  updateSources(d);
